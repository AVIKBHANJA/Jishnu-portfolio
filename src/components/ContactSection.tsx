      ...
      <div className="container mx-auto px-6" ref={ref}>
        ...
        >
          ...
          <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
            ...
            interested in biotechnology and stem cell biology.
          </p>
        </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {/* Additional Links */}
          <div>
            <h4 className="font-display text-lg md:text-xl font-medium text-foreground mb-3 md:m-4">
              Resume
            </h4>
            <div className="flex flex-wrap gap-2 md:gap-3">
              <a
                href="/assets/Jishnu_Sarathi_Europass_CV.pdf"
                download
